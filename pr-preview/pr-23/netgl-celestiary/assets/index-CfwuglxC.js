...
`,ra=1,Dp=(i=ra)=>{const e={portalPos:{value:new I},portalNormal:{value:new I},portalRight:{value:new I},portalUp:{value:new I},portalHalfW:{value:1},portalHalfH:{value:1.5},hostCameraPos:{value:new I},hostInverseViewProjection:{value:new je},hostViewMatrix:{value:new je},hostProjectionMatrix:{value:new je},destinationBackground:{value:new I(0,0,0)}},t=new an({uniforms:e,vertexShader:Cp,fragmentShader:Pp,depthTest:!0,depthWrite:!1,side:Wt,stencilWrite:!0,stencilFunc:zs,stencilRef:i,stencilFail:Ot,stencilZFail:Ot,stencilZPass:Kl,stencilWriteMask:255}),n=new Rt(new Nn(2,2),t);n.frustumCulled=!1;const r=new Vo;r.add(n);const s=new na(-1,1,1,-1,0,1),a=new je,o=new I(0,0,1),c=new I(1,0,0),l=new I(0,1,0),h=new gn;return{scene:r,camera:s,update:(f,m,v)=>{const x=f.userData.portalSize;e.portalHalfW.value=x?x.x/2:1,e.portalHalfH.value=x?x.y/2:1.5,f.getWorldPosition(e.portalPos.value),f.getWorldQuaternion(h),e.portalNormal.value.copy(o).applyQuaternion(h),e.portalRight.value.copy(c).applyQuaternion(h),e.portalUp.value.copy(l).applyQuaternion(h),m.getWorldPosition(e.hostCameraPos.value),a.multiplyMatrices(m.projectionMatrix,m.matrixWorldInverse),e.hostInverseViewProjection.value.copy(a).invert(),e.hostViewMatrix.value.copy(m.matrixWorldInverse),e.hostProjectionMatrix.value.copy(m.projectionMatrix),e.destinationBackground.value.set(v.r,v.g,v.b)}}},el=(i,e)=>{i.traverse(t=>{const n=t;if(!n.isMesh||!n.material)return;const r=Array.isArray(n.material)?n.material:[n.material];for(const s of r)e(s)})},Lp=(i,e=ra)=>{el(i,t=>{t.stencilWrite=!0,t.stencilFunc=$l,t.stencilRef=e,t.stencilFail=Ot,t.stencilZFail=Ot,t.stencilZPass=Ot,t.stencilWriteMask=0})},Up=i=>{el(i,e=>{e.stencilWrite=!1})},Zr=new gn,ji=new I,Ji=new I,Qi=new I,Ip=(i,e)=>e||(i.background instanceof Oe?i.background:new Oe(0,0,0)),Np=i=>{const{scene:e,anchor:t}=i,n=i.portalNormal??new I(0,0,1),r=i.stencilRef??ra;return{scene:e,anchor:t,getAnchor:()=>{t.getWorldPosition(ji),t.getWorldQuaternion(Zr),Ji.copy(n).applyQuaternion(Zr).normalize(),Qi.set(0,1,0).applyQuaternion(Zr).normalize();const o=t.userData.portalSize;return{position:[ji.x,ji.y,ji.z],normal:[Ji.x,Ji.y,Ji.z],up:[Qi.x,Qi.y,Qi.z],halfWidth:o?o.x/2:void 0,halfHeight:o?o.y/2:void 0}},getBackground:()=>{const o=Ip(e,i.background);return{r:o.r,g:o.g,b:o.b}},tick:i.tick,renderAsSource(o,c){o.render(e,c)},renderAsDestination(o,c){const l=e.background;e.background=null,Lp(e,r),o.render(e,c),Up(e),e.background=l}}},Fp=i=>{const e=i.outputOrigin??"*",t=i.inputFilter??null;return{post(n,r){i.output.postMessage(n,e,r??[])},onMessage(n){const r=s=>{if(t!==null&&s.source!==t)return;const a=s.data;!a||typeof a!="object"||n(a)};return window.addEventListener("message",r),()=>window.removeEventListener("message",r)}}},Op=[{key:"three",label:"Local three",description:"Two scenes in one process. Per-pixel halfspace stencil; no transport."},{key:"iframe",label:"Iframe (frame-RPC)",description:"Destination via postMessage; ships color + packed-RGBA depth bitmaps; host composites."},{key:"worker",label:"Web Worker",description:"Destination in a worker via OffscreenCanvas; no DOM."},{key:"netgl",label:"NetGL (command-stream)",description:"Destination's GL calls cross the wire and execute in the host's WebGL2 context."},{key:"netgl-celestiary",label:"NetGL + celestiary",description:"NetGL carrying celestiary (textured planets, custom shaders, RT post-processing)."}],Bp=`
#portal-nav-toggle {
  position: fixed;
  top: 12px;
  right: 12px;
...
`,zp='<svg width="22" height="22" viewBox="0 0 24 24" aria-hidden="true" fill="none"><path d="M3 6h18M3 12h18M3 18h18" stroke="currentColor" stroke-width="2" stroke-linecap="round"/></svg>',uo='<svg width="22" height="22" viewBox="0 0 24 24" aria-hidden="true" fill="none"><path d="M6 6l12 12M18 6L6 18" stroke="currentColor" stroke-width="2" stroke-linecap="round"/></svg>',Hp=(i,e)=>{const t=i==="three";return e==="three"?t?".":"..":t?`${e}/`:`../${e}/`},ho=i=>i.replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e]),Vp=i=>{if(document.getElementById("portal-nav-toggle"))return;const e=document.createElement("style");e.id="portal-nav-styles",e.textContent=Bp,document.head.appendChild(e);const t=document.createElement("aside");t.id="portal-nav-drawer",t.setAttribute("aria-hidden","false"),t.setAttribute("aria-label","Portal demos"),t.innerHTML=`
  ...
  `;const n=document.createElement("button");n.id="portal-nav-toggle",n.type="button",n.setAttribute("aria-label","Close demos menu"),n.setAttribute("aria-expanded","true"),n.setAttribute("aria-controls","portal-nav-drawer"),n.innerHTML=uo,document.body.appendChild(t),document.body.appendChild(n);const r=s=>{t.setAttribute("aria-hidden",s?"false":"true"),n.setAttribute("aria-expanded",s?"true":"false"),n.setAttribute("aria-label",s?"Close demos menu":"Toggle demos menu"),n.innerHTML=s?uo:zp};n.addEventListener("click",s=>{s.stopPropagation(),r(t.getAttribute("aria-hidden")!=="false")}),document.addEventListener("click",s=>{t.getAttribute("aria-hidden")==="true"||s.target?.closest("#portal-nav-drawer, #portal-nav-toggle")||r(!1)}),document.addEventListener("keydown",s=>{s.key==="Escape"&&t.getAttribute("aria-hidden")==="false"&&r(!1)})},Gp=(i,e,t={})=>{const n=t.moveSpeed??4,r=t.lookSensitivity??.0025;let s=0,a=0;const o=new Set;kp(e,(w,R)=>{s-=w*r,a-=R*r,a=Math.max(-Math.PI/2+.01,Math.min(Math.PI/2-.01,a))}),window.addEventListener("keydown",w=>o.add(w.code)),window.addEventListener("keyup",w=>o.delete(w.code)),Wp(o);const c=new I,l=new I,h=new I,d=w=>{i.quaternion.setFromEuler(new Ut(a,s,0,"YXZ")),l.set(0,0,-1).applyQuaternion(i.quaternion),h.set(1,0,0).applyQuaternion(i.quaternion),c.set(0,0,0),o.has("KeyW")&&c.add(l),o.has("KeyS")&&c.sub(l),o.has("KeyD")&&c.add(h),o.has("KeyA")&&c.sub(h),c.y=0,c.lengthSq()>0&&(c.normalize().multiplyScalar(n*w),i.position.add(c))},f=new je,m=new gn,v=new Ut(0,0,0,"YXZ"),x=new I(0,0,0),p=new I,u=new I(0,1,0);return{update:d,setOrientationFromForward:w=>{p.copy(w).normalize(),f.lookAt(x,p,u),m.setFromRotationMatrix(f),v.setFromQuaternion(m,"YXZ"),a=v.x,s=v.y},clearKeys:()=>{o.clear()},getKeys:()=>Array.from(o),setKeys:w=>{o.clear();for(const R of w)o.add(R)}}},kp=(i,e)=>{let t=null,n=0,r=0;i.addEventListener("pointerdown",a=>{if(t===null&&(t=a.pointerId,n=a.clientX,r=a.clientY,a.pointerType!=="mouse"))try{i.setPointerCapture(a.pointerId)}catch{}});const s=a=>{a.pointerId===t&&(t=null)};window.addEventListener("pointerup",s),window.addEventListener("pointercancel",s),window.addEventListener("pointermove",a=>{if(a.pointerId!==t)return;const o=a.clientX-n,c=a.clientY-r;n=a.clientX,r=a.clientY,e(o,c)})},Wp=i=>{if(!(typeof window<"u"&&("ontouchstart"in window||(navigator.maxTouchPoints??0)>0)))return;const t=document.createElement("div");t.className="wasd-pad",t.setAttribute("aria-label","Movement controls"),t.innerHTML=`
  ...
  `,document.head.appendChild(n),document.body.appendChild(t);for(const r of t.querySelectorAll(".wasd-btn")){const s=r.dataset.key,a=c=>{c.preventDefault(),c.stopPropagation(),i.add(s),r.classList.add("is-active");try{r.setPointerCapture(c.pointerId)}catch{}},o=c=>{c.stopPropagation(),i.delete(s),r.classList.remove("is-active")};r.addEventListener("pointerdown",a),r.addEventListener("pointerup",o),r.addEventListener("pointercancel",o),r.addEventListener("pointerleave",o),r.addEventListener("contextmenu",c=>c.preventDefault())}},Xp={Int8Array,Uint8Array,Uint8ClampedArray,Int16Array,Uint16Array,Int32Array,Uint32Array,Float32Array,Float64Array},qp=i=>{const e=new Map,t=n=>{if(n==null)return null;const r=typeof n;if(r==="number"||r==="string"||r==="boolean")return n;if(Array.isArray(n))return n.map(t);if(typeof n!="object")return n;const s=n;if("__netgl_handle"in s){const a=s.__netgl_handle,o=e.get(a);if(o===void 0)throw new Error(`NetGL replay: unknown handle id ${a}`);return o}if("__netgl_typedarray"in s){const a=s.__netgl_typedarray,o=Xp[a];if(!o)throw new Error(`NetGL replay: unknown typed-array ${a}`);return new o(s.buffer,s.offset,s.length)}if("__netgl_arraybuffer"in s)return s.__netgl_arraybuffer;if("__netgl_imagedata"in s){const a=s.width,o=s.height,c=s.buffer,l=new Uint8ClampedArray(c);return new ImageData(l,a,o)}throw new Error("NetGL replay: unknown encoded value shape")};return n=>{let r;try{r=n.args.map(t)}catch(o){const c=o instanceof Error?o.message:String(o);throw new Error(`NetGL replay (decoding ${n.name}): ${c}`)}const s=i[n.name];if(typeof s!="function")throw new Error(`NetGL replay: receiver has no method '${n.name}'`);const a=s.apply(i,r);n.returnId!==void 0&&a!=null&&typeof a=="object"&&e.set(n.returnId,a)}},Yp=i=>typeof i=="object"&&i!==null&&typeof i.name=="string",Kp=i=>typeof i=="object"&&i!==null&&i.type==="netgl:frame-end";Vp("netgl-celestiary");const tl=document.querySelector("#app");if(!tl)throw new Error("Missing #app");const ks=document.querySelector("#target-iframe");if(!ks)throw new Error("Missing #target-iframe");const dt=new bp({antialias:!1,stencil:!0,depth:!0,preserveDrawingBuffer:!1});dt.outputColorSpace=wt;dt.toneMapping=rn;dt.setPixelRatio(Math.min(window.devicePixelRatio,2));dt.setSize(window.innerWidth,window.innerHeight);dt.autoClear=!1;tl.appendChild(dt.domElement);const kt=new Lt(70,window.innerWidth/window.innerHeight,.02,200);kt.position.set(0,1.6,5.5);const Fn=new Vo;Fn.background=new Oe("#101826");Fn.add(new Fc(12176639,2241348,1));const nl=new zc(16777215,.65);nl.position.set(3,6,2);Fn.add(nl);const il=new Rt(new Nn(18,18),new Wo({color:"#1b2a3f",roughness:.95,metalness:.03}));il.rotation.x=-Math.PI/2;Fn.add(il);const $p=new ai(.9,.9,.9),Zp=new Wo({color:"#5da9ff",roughness:.35});for(let i=0;i<14;i+=1){const e=new Rt($p,Zp);e.position.set(Math.sin(i*.5)*4,.45,-3-i*.65),Fn.add(e)}const jp=new Ve(2.6,3.2),fr=Rp(jp);fr.position.set(0,1.6,-3.5);Fn.add(fr);const fo=Np({scene:Fn,anchor:fr}),jr=Dp(),Jp=dt.getContext(),Qp=qp(Jp);let rl=!1,Ws=null;const sl=new Oe("#000000"),al=Fp({output:ks.contentWindow,inputFilter:ks.contentWindow});let pi=[],gi=null,po=null,mo=!1,_o=!1;al.onMessage(i=>{const e=i;if(e?.type==="netgl:debug"){e.extra!==void 0?console.log(`[host←shim] ${e.msg}`,e.extra):console.log(`[host←shim] ${e.msg}`);return}if(Kp(i)){_o||(_o=!0,console.log(`[host] first frame-end received (${pi.length} calls)`)),gi?gi.push(...pi):gi=pi,pi=[];return}if(Yp(i)){mo||(mo=!0,console.log(`[host] first NetGLCall received: ${i.name}`)),pi.push(i);return}const t=i;t&&t.type==="netgl:ready"&&(console.log("[host] netgl:ready received from iframe",t.anchor),Ws=t.anchor,sl.setRGB(t.background.r,t.background.g,t.background.b),rl=!0)});const em=Gp(kt,dt.domElement),tm=()=>{const i=window.innerWidth,e=window.innerHeight;dt.setSize(i,e),kt.aspect=i/e,kt.updateProjectionMatrix()};window.addEventListener("resize",tm);const go=new Vc,vo=new Oe,er=new I,tr=new I,nr=new I,ol=()=>{const i=go.getDelta(),e=go.elapsedTime;if(em.update(i),dt.resetState(),dt.setRenderTarget(null),dt.clear(!0,!0,!0),fo.renderAsSource(dt,kt),rl&&Ws){vo.copy(sl),jr.update(fr,kt,vo),dt.render(jr.scene,jr.camera),dt.clearDepth();let t=gi;if(t?(gi=null,po=t):t=po,t){for(let c=0;c<t.length;c+=1)Qp(t[c]);dt.resetState()}kt.getWorldPosition(er),tr.set(0,0,-1).applyQuaternion(kt.quaternion),nr.set(0,1,0).applyQuaternion(kt.quaternion);const n=wp({position:[er.x,er.y,er.z],forward:[tr.x,tr.y,tr.z],up:[nr.x,nr.y,nr.z]},{source:fo.getAnchor(),target:Ws}),r=Array.from(kt.projectionMatrix.elements),s=dt.getPixelRatio(),a=Math.max(1,Math.floor(window.innerWidth*s)),o=Math.max(1,Math.floor(window.innerHeight*s));al.post({type:"netgl:setPose",pose:n,projection:r,viewport:{width:a,height:o},time:e})}requestAnimationFrame(ol)};ol();
