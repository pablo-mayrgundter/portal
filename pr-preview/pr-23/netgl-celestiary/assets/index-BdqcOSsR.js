...
`)}function Vf(i,e){const t={},n=i.getProgramParameter(e,i.ACTIVE_ATTRIBUTES);for(let r=0;r<n;r++){const s=i.getActiveAttrib(e,r),a=s.name;let o=1;s.type===i.FLOAT_MAT2&&(o=2),s.type===i.FLOAT_MAT3&&(o=3),s.type===i.FLOAT_MAT4&&(o=4),t[a]={type:s.type,location:i.getAttribLocation(e,a),locationSize:o}}return t}function pi(i){return i!==""}function to(i,e){const t=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return i.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,t).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function no(i,e){return i.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const Gf=/^[ \t]*#include +<([\w\d./]+)>/gm;function Vs(i){return i.replace(Gf,Wf)}const kf=new Map;function Wf(i,e){let t=Ne[e];if(t===void 0){const n=kf.get(e);if(n!==void 0)t=Ne[n],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,n);else throw new Error("Can not resolve #include <"+e+">")}return Vs(t)}const Xf=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function io(i){return i.replace(Xf,qf)}function qf(i,e,t,n){let r="";for(let s=parseInt(e);s<parseInt(t);s++)r+=n.replace(/\[\s*i\s*\]/g,"[ "+s+" ]").replace(/UNROLLED_LOOP_INDEX/g,s);return r}function ro(i){let e=`precision ${i.precision} float;
...
`,Hp='<svg width="22" height="22" viewBox="0 0 24 24" aria-hidden="true" fill="none"><path d="M3 6h18M3 12h18M3 18h18" stroke="currentColor" stroke-width="2" stroke-linecap="round"/></svg>',ho='<svg width="22" height="22" viewBox="0 0 24 24" aria-hidden="true" fill="none"><path d="M6 6l12 12M18 6L6 18" stroke="currentColor" stroke-width="2" stroke-linecap="round"/></svg>',Vp=(i,e)=>{const t=i==="three";return e==="three"?t?".":"..":t?`${e}/`:`../${e}/`},fo=i=>i.replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e]),Gp=i=>{if(document.getElementById("portal-nav-toggle"))return;const e=document.createElement("style");e.id="portal-nav-styles",e.textContent=zp,document.head.appendChild(e);const t=document.createElement("aside");t.id="portal-nav-drawer",t.setAttribute("aria-hidden","false"),t.setAttribute("aria-label","Portal demos"),t.innerHTML=`
  ...
  `,document.head.appendChild(n),document.body.appendChild(t);for(const r of t.querySelectorAll(".wasd-btn")){const s=r.dataset.key,a=c=>{c.preventDefault(),c.stopPropagation(),i.add(s),r.classList.add("is-active");try{r.setPointerCapture(c.pointerId)}catch{}},o=c=>{c.stopPropagation(),i.delete(s),r.classList.remove("is-active")};r.addEventListener("pointerdown",a),r.addEventListener("pointerup",o),r.addEventListener("pointercancel",o),r.addEventListener("pointerleave",o),r.addEventListener("contextmenu",c=>c.preventDefault())}},qp={Int8Array,Uint8Array,Uint8ClampedArray,Int16Array,Uint16Array,Int32Array,Uint32Array,Float32Array,Float64Array},Yp=i=>{const e=new Map,t=n=>{if(n==null)return null;const r=typeof n;if(r==="number"||r==="string"||r==="boolean")return n;if(Array.isArray(n))return n.map(t);if(typeof n!="object")return n;const s=n;if("__netgl_handle"in s){const a=s.__netgl_handle,o=e.get(a);if(o===void 0)throw new Error(`NetGL replay: unknown handle id ${a}`);return o}if("__netgl_typedarray"in s){const a=s.__netgl_typedarray,o=qp[a];if(!o)throw new Error(`NetGL replay: unknown typed-array ${a}`);return new o(s.buffer,s.offset,s.length)}if("__netgl_arraybuffer"in s)return s.__netgl_arraybuffer;if("__netgl_imagedata"in s){const a=s.width,o=s.height,c=s.buffer,l=new Uint8ClampedArray(c);return new ImageData(l,a,o)}throw new Error("NetGL replay: unknown encoded value shape")};return n=>{const r=n.args.map(t),s=i[n.name];if(typeof s!="function")throw new Error(`NetGL replay: receiver has no method '${n.name}'`);const a=s.apply(i,r);n.returnId!==void 0&&a!=null&&typeof a=="object"&&e.set(n.returnId,a)}},Kp=i=>typeof i=="object"&&i!==null&&typeof i.name=="string",$p=i=>typeof i=="object"&&i!==null&&i.type==="netgl:frame-end";Gp("netgl-celestiary");const nl=document.querySelector("#app");if(!nl)throw new Error("Missing #app");const ks=document.querySelector("#target-iframe");if(!ks)throw new Error("Missing #target-iframe");const dt=new Ap({antialias:!1,stencil:!0,depth:!0,preserveDrawingBuffer:!1});dt.outputColorSpace=wt;dt.toneMapping=rn;dt.setPixelRatio(Math.min(window.devicePixelRatio,2));dt.setSize(window.innerWidth,window.innerHeight);dt.autoClear=!1;nl.appendChild(dt.domElement);const kt=new Lt(70,window.innerWidth/window.innerHeight,.02,200);kt.position.set(0,1.6,5.5);const Fn=new Go;Fn.background=new Oe("#101826");Fn.add(new Oc(12176639,2241348,1));const il=new Hc(16777215,.65);il.position.set(3,6,2);Fn.add(il);const rl=new Rt(new Nn(18,18),new Xo({color:"#1b2a3f",roughness:.95,metalness:.03}));rl.rotation.x=-Math.PI/2;Fn.add(rl);const Zp=new ai(.9,.9,.9),jp=new Xo({color:"#5da9ff",roughness:.35});for(let i=0;i<14;i+=1){const e=new Rt(Zp,jp);e.position.set(Math.sin(i*.5)*4,.45,-3-i*.65),Fn.add(e)}const Jp=new Ve(2.6,3.2),fr=Cp(Jp);fr.position.set(0,1.6,-3.5);Fn.add(fr);const po=Fp({scene:Fn,anchor:fr}),jr=Lp(),Qp=dt.getContext(),em=Yp(Qp);let sl=!1,Ws=null;const al=new Oe("#000000"),ol=Op({output:ks.contentWindow,inputFilter:ks.contentWindow});let Ji=[],Xs=null,mo=null,_o=!1,go=0,Qi=0;ol.onMessage(i=>{const e=i;if(e?.type==="netgl:debug"){e.extra!==void 0?console.log(`[host←shim] ${e.msg}`,e.extra):console.log(`[host←shim] ${e.msg}`);return}if($p(i)){Qi+=1,Qi===1&&console.log(`[host] first frame-end received (${Ji.length} calls)`),Qi%120===0&&console.log(`[host] ${Qi} frames, ${go} calls so far`),Xs=Ji,Ji=[];return}if(Kp(i)){_o||(_o=!0,console.log(`[host] first NetGLCall received: ${i.name}`)),go+=1,Ji.push(i);return}const t=i;t&&t.type==="netgl:ready"&&(console.log("[host] netgl:ready received from iframe",t.anchor),Ws=t.anchor,al.setRGB(t.background.r,t.background.g,t.background.b),sl=!0)});const tm=kp(kt,dt.domElement),nm=()=>{const i=window.innerWidth,e=window.innerHeight;dt.setSize(i,e),kt.aspect=i/e,kt.updateProjectionMatrix()};window.addEventListener("resize",nm);const vo=new Gc,xo=new Oe,er=new I,tr=new I,nr=new I,ll=()=>{const i=vo.getDelta(),e=vo.elapsedTime;if(tm.update(i),dt.resetState(),dt.setRenderTarget(null),dt.clear(!0,!0,!0),po.renderAsSource(dt,kt),sl&&Ws){xo.copy(al),jr.update(fr,kt,xo),dt.render(jr.scene,jr.camera),dt.clearDepth();let t=Xs;if(t?(Xs=null,mo=t):t=mo,t){for(let c=0;c<t.length;c+=1)em(t[c]);dt.resetState()}kt.getWorldPosition(er),tr.set(0,0,-1).applyQuaternion(kt.quaternion),nr.set(0,1,0).applyQuaternion(kt.quaternion);const n=Rp({position:[er.x,er.y,er.z],forward:[tr.x,tr.y,tr.z],up:[nr.x,nr.y,nr.z]},{source:po.getAnchor(),target:Ws}),r=Array.from(kt.projectionMatrix.elements),s=dt.getPixelRatio(),a=Math.max(1,Math.floor(window.innerWidth*s)),o=Math.max(1,Math.floor(window.innerHeight*s));ol.post({type:"netgl:setPose",pose:n,projection:r,viewport:{width:a,height:o},time:e})}requestAnimationFrame(ll)};ll();
