...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:mn,depthTest:!1,depthWrite:!1})}function qa(){return new an({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:oa(),fragmentShader:`
		...
		`,blending:mn,depthTest:!1,depthWrite:!1})}function Ya(){return new an({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:oa(),fragmentShader:`
...
#define LOW_PRECISION`),e}function jf(i){let e="SHADOWMAP_TYPE_BASIC";return i.shadowMapType===To?e="SHADOWMAP_TYPE_PCF":i.shadowMapType===Sl?e="SHADOWMAP_TYPE_PCF_SOFT":i.shadowMapType===tn&&(e="SHADOWMAP_TYPE_VSM"),e}function Jf(i){let e="ENVMAP_TYPE_CUBE";if(i.envMap)switch(i.envMapMode){case ni:case ii:e="ENVMAP_TYPE_CUBE";break;case fr:e="ENVMAP_TYPE_CUBE_UV";break}return e}function Qf(i){let e="ENVMAP_MODE_REFLECTION";return i.envMap&&i.envMapMode===ii&&(e="ENVMAP_MODE_REFRACTION"),e}function ep(i){let e="ENVMAP_BLENDING_NONE";if(i.envMap)switch(i.combine){case bo:e="ENVMAP_BLENDING_MULTIPLY";break;case Hl:e="ENVMAP_BLENDING_MIX";break;case Vl:e="ENVMAP_BLENDING_ADD";break}return e}function tp(i){const e=i.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),112)),texelHeight:n,maxMip:t}}function np(i,e,t,n){const r=i.getContext(),s=t.defines;let a=t.vertexShader,o=t.fragmentShader;const l=jf(t),c=Jf(t),h=Qf(t),d=ep(t),f=tp(t),m=kf(t),v=Wf(s),x=r.createProgram();let p,u,A=t.glslVersion?"#version "+t.glslVersion+`
...
`,la=1,Fp=(i=la)=>{const e={portalPos:{value:new I},portalNormal:{value:new I},portalRight:{value:new I},portalUp:{value:new I},portalHalfW:{value:1},portalHalfH:{value:1.5},hostCameraPos:{value:new I},hostInverseViewProjection:{value:new je},hostViewMatrix:{value:new je},hostProjectionMatrix:{value:new je},destinationBackground:{value:new I(0,0,0)}},t=new an({uniforms:e,vertexShader:Ip,fragmentShader:Np,depthTest:!0,depthWrite:!1,side:Wt,stencilWrite:!0,stencilFunc:Gs,stencilRef:i,stencilFail:Bt,stencilZFail:Bt,stencilZPass:Ql,stencilWriteMask:255}),n=new Rt(new Nn(2,2),t);n.frustumCulled=!1;const r=new qo;r.add(n);const s=new aa(-1,1,1,-1,0,1),a=new je,o=new I(0,0,1),l=new I(1,0,0),c=new I(0,1,0),h=new gn;return{scene:r,camera:s,update:(f,m,v)=>{const x=f.userData.portalSize;e.portalHalfW.value=x?x.x/2:1,e.portalHalfH.value=x?x.y/2:1.5,f.getWorldPosition(e.portalPos.value),f.getWorldQuaternion(h),e.portalNormal.value.copy(o).applyQuaternion(h),e.portalRight.value.copy(l).applyQuaternion(h),e.portalUp.value.copy(c).applyQuaternion(h),m.getWorldPosition(e.hostCameraPos.value),a.multiplyMatrices(m.projectionMatrix,m.matrixWorldInverse),e.hostInverseViewProjection.value.copy(a).invert(),e.hostViewMatrix.value.copy(m.matrixWorldInverse),e.hostProjectionMatrix.value.copy(m.projectionMatrix),e.destinationBackground.value.set(v.r,v.g,v.b)}}},sl=(i,e)=>{i.traverse(t=>{const n=t;if(!n.isMesh||!n.material)return;const r=Array.isArray(n.material)?n.material:[n.material];for(const s of r)e(s)})},Op=(i,e=la)=>{sl(i,t=>{t.stencilWrite=!0,t.stencilFunc=ec,t.stencilRef=e,t.stencilFail=Bt,t.stencilZFail=Bt,t.stencilZPass=Bt,t.stencilWriteMask=0})},Bp=i=>{sl(i,e=>{e.stencilWrite=!1})},jn=new I,zp=(i,e,t,n)=>{let r,s;{const u=i.userData?.portalSize;r=u?u.x/2:.5,s=u?u.y/2:.5}if(i.updateMatrixWorld(!0),!e.matrixWorldInverse)return null;let a=1/0,o=1/0,l=-1/0,c=-1/0,h=0;for(let u=0;u<4;u+=1){const A=(u&1)===0?-r:r,b=(u&2)===0?-s:s;if(jn.set(A,b,0),jn.applyMatrix4(i.matrixWorld),jn.project(e),jn.z>1)continue;h+=1;const y=(jn.x+1)*.5*t.width,P=(jn.y+1)*.5*t.height;y<a&&(a=y),y>l&&(l=y),P<o&&(o=P),P>c&&(c=P)}if(h===0)return null;const d=Math.max(0,Math.floor(a)),f=Math.max(0,Math.floor(o)),m=Math.min(t.width,Math.ceil(l)),v=Math.min(t.height,Math.ceil(c)),x=Math.max(0,m-d),p=Math.max(0,v-f);return x===0||p===0?null:{x:d,y:f,w:x,h:p}},jr=new gn,Qi=new I,er=new I,tr=new I,Hp=(i,e)=>e||(i.background instanceof Oe?i.background:new Oe(0,0,0)),Vp=i=>{const{scene:e,anchor:t}=i,n=i.portalNormal??new I(0,0,1),r=i.stencilRef??la;return{scene:e,anchor:t,getAnchor:()=>{t.getWorldPosition(Qi),t.getWorldQuaternion(jr),er.copy(n).applyQuaternion(jr).normalize(),tr.set(0,1,0).applyQuaternion(jr).normalize();const o=t.userData.portalSize;return{position:[Qi.x,Qi.y,Qi.z],normal:[er.x,er.y,er.z],up:[tr.x,tr.y,tr.z],halfWidth:o?o.x/2:void 0,halfHeight:o?o.y/2:void 0}},getBackground:()=>{const o=Hp(e,i.background);return{r:o.r,g:o.g,b:o.b}},tick:i.tick,renderAsSource(o,l){o.render(e,l)},renderAsDestination(o,l){const c=e.background;e.background=null,Op(e,r),o.render(e,l),Bp(e),e.background=c}}},Gp=i=>{const e=i.outputOrigin??"*",t=i.inputFilter??null;return{post(n,r){i.output.postMessage(n,e,r??[])},onMessage(n){const r=s=>{if(t!==null&&s.source!==t)return;const a=s.data;!a||typeof a!="object"||n(a)};return window.addEventListener("message",r),()=>window.removeEventListener("message",r)}}},kp=[{key:"three",label:"Local three",description:"Two scenes in one process. Per-pixel halfspace stencil; no transport."},{key:"iframe",label:"Iframe (frame-RPC)",description:"Destination via postMessage; ships color + packed-RGBA depth bitmaps; host composites."},{key:"worker",label:"Web Worker",description:"Destination in a worker via OffscreenCanvas; no DOM."},{key:"netgl",label:"NetGL (command-stream)",description:"Destination's GL calls cross the wire and execute in the host's WebGL2 context."},{key:"netgl-celestiary",label:"NetGL + celestiary",description:"NetGL carrying celestiary (textured planets, custom shaders, RT post-processing)."}],Wp=`
#portal-nav-toggle {
  position: fixed;
  top: 12px;
  right: 12px;
...
`,Xp='<svg width="22" height="22" viewBox="0 0 24 24" aria-hidden="true" fill="none"><path d="M3 6h18M3 12h18M3 18h18" stroke="currentColor" stroke-width="2" stroke-linecap="round"/></svg>',mo='<svg width="22" height="22" viewBox="0 0 24 24" aria-hidden="true" fill="none"><path d="M6 6l12 12M18 6L6 18" stroke="currentColor" stroke-width="2" stroke-linecap="round"/></svg>',qp=(i,e)=>{const t=i==="three";return e==="three"?t?".":"..":t?`${e}/`:`../${e}/`},_o=i=>i.replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e]),Yp=i=>{if(document.getElementById("portal-nav-toggle"))return;const e=document.createElement("style");e.id="portal-nav-styles",e.textContent=Wp,document.head.appendChild(e);const t=document.createElement("aside");t.id="portal-nav-drawer",t.setAttribute("aria-hidden","false"),t.setAttribute("aria-label","Portal demos"),t.innerHTML=`
    <h2>Portal demos</h2>
    <p class="portal-nav-subtitle">Same scenes, different wire.</p>
    <ul>
      ${kp.map(s=>`
        <li${s.key===i?' class="portal-nav-current"':""}>
          <a href="${qp(i,s.key)}"${s.key===i?' aria-current="page"':""}>
            <span class="portal-nav-label">${_o(s.label)}</span>
            <span class="portal-nav-desc">${_o(s.description)}</span>
          </a>
        </li>
      `).join("")}
    </ul>
  ...
  `;const n=document.createElement("button");n.id="portal-nav-toggle",n.type="button",n.setAttribute("aria-label","Close demos menu"),n.setAttribute("aria-expanded","true"),n.setAttribute("aria-controls","portal-nav-drawer"),n.innerHTML=mo,document.body.appendChild(t),document.body.appendChild(n);const r=s=>{t.setAttribute("aria-hidden",s?"false":"true"),n.setAttribute("aria-expanded",s?"true":"false"),n.setAttribute("aria-label",s?"Close demos menu":"Toggle demos menu"),n.innerHTML=s?mo:Xp};n.addEventListener("click",s=>{s.stopPropagation(),r(t.getAttribute("aria-hidden")!=="false")}),document.addEventListener("click",s=>{t.getAttribute("aria-hidden")==="true"||s.target?.closest("#portal-nav-drawer, #portal-nav-toggle")||r(!1)}),document.addEventListener("keydown",s=>{s.key==="Escape"&&t.getAttribute("aria-hidden")==="false"&&r(!1)})},Kp=(i,e,t={})=>{const n=t.moveSpeed??4,r=t.lookSensitivity??.0025;let s=0,a=0;const o=new Set;$p(e,(w,R)=>{s-=w*r,a-=R*r,a=Math.max(-Math.PI/2+.01,Math.min(Math.PI/2-.01,a))}),window.addEventListener("keydown",w=>o.add(w.code)),window.addEventListener("keyup",w=>o.delete(w.code)),Zp(o);const l=new I,c=new I,h=new I,d=w=>{i.quaternion.setFromEuler(new Ut(a,s,0,"YXZ")),c.set(0,0,-1).applyQuaternion(i.quaternion),h.set(1,0,0).applyQuaternion(i.quaternion),l.set(0,0,0),o.has("KeyW")&&l.add(c),o.has("KeyS")&&l.sub(c),o.has("KeyD")&&l.add(h),o.has("KeyA")&&l.sub(h),l.y=0,l.lengthSq()>0&&(l.normalize().multiplyScalar(n*w),i.position.add(l))},f=new je,m=new gn,v=new Ut(0,0,0,"YXZ"),x=new I(0,0,0),p=new I,u=new I(0,1,0);return{update:d,setOrientationFromForward:w=>{p.copy(w).normalize(),f.lookAt(x,p,u),m.setFromRotationMatrix(f),v.setFromQuaternion(m,"YXZ"),a=v.x,s=v.y},clearKeys:()=>{o.clear()},getKeys:()=>Array.from(o),setKeys:w=>{o.clear();for(const R of w)o.add(R)}}},$p=(i,e)=>{let t=null,n=0,r=0;i.addEventListener("pointerdown",a=>{if(t===null&&(t=a.pointerId,n=a.clientX,r=a.clientY,a.pointerType!=="mouse"))try{i.setPointerCapture(a.pointerId)}catch{}});const s=a=>{a.pointerId===t&&(t=null)};window.addEventListener("pointerup",s),window.addEventListener("pointercancel",s),window.addEventListener("pointermove",a=>{if(a.pointerId!==t)return;const o=a.clientX-n,l=a.clientY-r;n=a.clientX,r=a.clientY,e(o,l)})},Zp=i=>{if(!(typeof window<"u"&&("ontouchstart"in window||(navigator.maxTouchPoints??0)>0)))return;const t=document.createElement("div");t.className="wasd-pad",t.setAttribute("aria-label","Movement controls"),t.innerHTML=`
  ...
  `,document.head.appendChild(n),document.body.appendChild(t);for(const r of t.querySelectorAll(".wasd-btn")){const s=r.dataset.key,a=l=>{l.preventDefault(),l.stopPropagation(),i.add(s),r.classList.add("is-active");try{r.setPointerCapture(l.pointerId)}catch{}},o=l=>{l.stopPropagation(),i.delete(s),r.classList.remove("is-active")};r.addEventListener("pointerdown",a),r.addEventListener("pointerup",o),r.addEventListener("pointercancel",o),r.addEventListener("pointerleave",o),r.addEventListener("contextmenu",l=>l.preventDefault())}},jp={Int8Array,Uint8Array,Uint8ClampedArray,Int16Array,Uint16Array,Int32Array,Uint32Array,Float32Array,Float64Array},Jp=36160,Qp=36009,em=(i,e={})=>{const t=new Map;let n=null,r=null;const s=a=>{if(a==null)return null;const o=typeof a;if(o==="number"||o==="string"||o==="boolean")return a;if(Array.isArray(a))return a.map(s);if(typeof a!="object")return a;const l=a;if("__netgl_handle"in l){const c=l.__netgl_handle,h=t.get(c);if(h===void 0)throw new Error(`NetGL replay: unknown handle id ${c}`);return h}if("__netgl_typedarray"in l){const c=l.__netgl_typedarray,h=jp[c];if(!h)throw new Error(`NetGL replay: unknown typed-array ${c}`);return new h(l.buffer,l.offset,l.length)}if("__netgl_arraybuffer"in l)return l.__netgl_arraybuffer;if("__netgl_imagedata"in l){const c=l.width,h=l.height,d=l.buffer,f=new Uint8ClampedArray(d);return new ImageData(f,c,h)}throw new Error("NetGL replay: unknown encoded value shape")};return a=>{let o;try{o=a.args.map(s)}catch(d){const f=d instanceof Error?d.message:String(d);throw new Error(`NetGL replay (decoding ${a.name}): ${f}`)}let l=!1;if(a.name==="bindFramebuffer"){const d=o[0];if(d===Jp||d===Qp){const f=o[1];f!==n&&(l=!0),n=f}}if(a.name==="viewport"){const[d,f,m,v]=o;if(r=[d,f,m,v],n===null&&e.remapScreenViewport){const x=e.remapScreenViewport(d,f,m,v);x!==null&&(o=[x[0],x[1],x[2],x[3]])}}if(e.__debugTraceViewport&&(a.name==="viewport"||a.name==="scissor"||a.name==="enable"||a.name==="disable"))if(a.name==="enable"||a.name==="disable")o[0]===3089&&e.__debugTraceViewport(`${a.name}(SCISSOR_TEST) drawFb=${n?"RT":"null"}`);else{const[d,f,m,v]=o;e.__debugTraceViewport(`${a.name}(${d},${f},${m}x${v}) drawFb=${n?"RT":"null"}`)}const c=i[a.name];if(typeof c!="function")throw new Error(`NetGL replay: receiver has no method '${a.name}'`);const h=c.apply(i,o);if(l&&r){const[d,f,m,v]=r;if(n===null&&e.remapScreenViewport){const x=e.remapScreenViewport(d,f,m,v);x!==null?i.viewport(x[0],x[1],x[2],x[3]):i.viewport(d,f,m,v)}else i.viewport(d,f,m,v);if(e.__debugTraceViewport){const x=n===null&&e.remapScreenViewport?e.remapScreenViewport(d,f,m,v)??[d,f,m,v]:[d,f,m,v];e.__debugTraceViewport(`post-bind re-issue viewport(${x[0]},${x[1]},${x[2]}x${x[3]}) drawFb=${n?"RT":"null"}`)}}a.returnId!==void 0&&h!=null&&typeof h=="object"&&t.set(a.returnId,h)}},tm=i=>typeof i=="object"&&i!==null&&typeof i.name=="string",nm=i=>typeof i=="object"&&i!==null&&i.type==="netgl:frame-end";Yp("netgl-celestiary");const al=document.querySelector("#app");if(!al)throw new Error("Missing #app");const qs=document.querySelector("#target-iframe");if(!qs)throw new Error("Missing #target-iframe");const dt=new Pp({antialias:!1,stencil:!0,depth:!0,preserveDrawingBuffer:!1});dt.outputColorSpace=wt;dt.toneMapping=rn;dt.setPixelRatio(Math.min(window.devicePixelRatio,2));dt.setSize(window.innerWidth,window.innerHeight);dt.autoClear=!1;al.appendChild(dt.domElement);const Ot=new Lt(70,window.innerWidth/window.innerHeight,.02,200);Ot.position.set(0,1.6,5.5);const Fn=new qo;Fn.background=new Oe("#101826");Fn.add(new Vc(12176639,2241348,1));const ol=new Wc(16777215,.65);ol.position.set(3,6,2);Fn.add(ol);const ll=new Rt(new Nn(18,18),new $o({color:"#1b2a3f",roughness:.95,metalness:.03}));ll.rotation.x=-Math.PI/2;Fn.add(ll);const im=new oi(.9,.9,.9),rm=new $o({color:"#5da9ff",roughness:.35});for(let i=0;i<14;i+=1){const e=new Rt(im,rm);e.position.set(Math.sin(i*.5)*4,.45,-3-i*.65),Fn.add(e)}const sm=new Ve(2.6,3.2),Ti=Up(sm);Ti.position.set(0,1.6,-3.5);Fn.add(Ti);const go=Vp({scene:Fn,anchor:Ti}),Jr=Fp(),am=dt.getContext();let Ys=null,Qr=0;const vo=40,om=em(am,{remapScreenViewport:(i,e,t,n)=>{const r=Ys;if(!r)return null;const s=t/n,a=r.w/r.h;let o,l;s>a?(l=r.h,o=r.h*s):(o=r.w,l=r.w/s);const c=r.x+(r.w-o)/2,h=r.y+(r.h-l)/2;return[Math.floor(c),Math.floor(h),Math.ceil(o),Math.ceil(l)]},__debugTraceViewport:i=>{Qr<vo&&(console.log(`[host] ${i}`),Qr++,Qr===vo&&console.log("[host] (viewport trace cap reached)"))}});let cl=!1,Ks=null;const ul=new Oe("#000000"),hl=Gp({output:qs.contentWindow,inputFilter:qs.contentWindow});let mi=[],vi=null,xo=null,Mo=!1,So=!1;hl.onMessage(i=>{const e=i;if(e?.type==="netgl:debug"){e.extra!==void 0?console.log(`[host←shim] ${e.msg}`,e.extra):console.log(`[host←shim] ${e.msg}`);return}if(nm(i)){So||(So=!0,console.log(`[host] first frame-end received (${mi.length} calls)`)),vi?vi.push(...mi):vi=mi,mi=[];return}if(tm(i)){Mo||(Mo=!0,console.log(`[host] first NetGLCall received: ${i.name}`)),mi.push(i);return}const t=i;t&&t.type==="netgl:ready"&&(console.log("[host] netgl:ready received from iframe",t.anchor),Ks=t.anchor,ul.setRGB(t.background.r,t.background.g,t.background.b),cl=!0)});const lm=Kp(Ot,dt.domElement),cm=()=>{const i=window.innerWidth,e=window.innerHeight;dt.setSize(i,e),Ot.aspect=i/e,Ot.updateProjectionMatrix()};window.addEventListener("resize",cm);const Eo=new qc,yo=new Oe,nr=new I,ir=new I,rr=new I;let es=0;const dl=()=>{const i=Eo.getDelta(),e=Eo.elapsedTime;if(lm.update(i),dt.resetState(),dt.setRenderTarget(null),dt.clear(!0,!0,!0),go.renderAsSource(dt,Ot),cl&&Ks){yo.copy(ul),Jr.update(Ti,Ot,yo),dt.render(Jr.scene,Jr.camera),dt.clearDepth();const t=dt.getPixelRatio(),n=Math.floor(window.innerWidth*t),r=Math.floor(window.innerHeight*t);Ys=zp(Ti,Ot,{width:n,height:r}),es<3&&console.log(`[host] frame ${es}: door rect`,Ys,`canvas ${n}x${r}`),es++;let s=vi;if(s?(vi=null,xo=s):s=xo,s){for(let h=0;h<s.length;h+=1)om(s[h]);dt.resetState()}Ot.getWorldPosition(nr),ir.set(0,0,-1).applyQuaternion(Ot.quaternion),rr.set(0,1,0).applyQuaternion(Ot.quaternion);const a=Lp({position:[nr.x,nr.y,nr.z],forward:[ir.x,ir.y,ir.z],up:[rr.x,rr.y,rr.z]},{source:go.getAnchor(),target:Ks}),o=Array.from(Ot.projectionMatrix.elements),l=Math.max(1,n),c=Math.max(1,r);hl.post({type:"netgl:setPose",pose:a,projection:o,viewport:{width:l,height:c},time:e})}requestAnimationFrame(dl)};dl();
