      ...
      ${ge.map(t=>`
        <li${t.key===e?' class="portal-nav-current"':""}>
          <a href="${be(e,t.key)}"${t.key===e?' aria-current="page"':""}>
            <span class="portal-nav-label">${F(t.label)}</span>
            <span class="portal-nav-desc">${F(t.description)}</span>
          </a>
        </li>
      `).join("")}
    </ul>
