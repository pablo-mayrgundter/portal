...
`,D='<svg width="22" height="22" viewBox="0 0 24 24" aria-hidden="true" fill="none"><path d="M3 6h18M3 12h18M3 18h18" stroke="currentColor" stroke-width="2" stroke-linecap="round"/></svg>',Ae='<svg width="22" height="22" viewBox="0 0 24 24" aria-hidden="true" fill="none"><path d="M6 6l12 12M18 6L6 18" stroke="currentColor" stroke-width="2" stroke-linecap="round"/></svg>',Ee=(e,t)=>{const r=e==="three";return t==="three"?r?".":"..":r?`${t}/`:`../${t}/`},F=e=>e.replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t]),Le=e=>{if(document.getElementById("portal-nav-toggle"))return;const t=document.createElement("style");t.id="portal-nav-styles",t.textContent=Me,document.head.appendChild(t);const r=document.createElement("aside");r.id="portal-nav-drawer",r.setAttribute("aria-hidden","true"),r.setAttribute("aria-label","Portal demos"),r.innerHTML=`
    <h2>Portal demos</h2>
