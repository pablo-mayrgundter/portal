import{V as Pe,P as de,M as Ke,a as q,b,c as R,S as je,R as $e,K as B,A as Ue,D as qe,d as Ae,O as Qe,Q as pe,C as G,e as Ye,f as Ce,E as Xe,g as fe,W as Ze,h as Je,N as et,i as tt,H as nt,j as rt,k as Re,B as at,l as ot}from"./three-helpers-WAzysoi4.js";const se=(e,t)=>[e[0]+t[0],e[1]+t[1],e[2]+t[2]],st=(e,t)=>[e[0]-t[0],e[1]-t[1],e[2]-t[2]],U=(e,t)=>[e[0]*t,e[1]*t,e[2]*t],J=(e,t)=>e[0]*t[0]+e[1]*t[1]+e[2]*t[2],we=(e,t)=>[e[1]*t[2]-e[2]*t[1],e[2]*t[0]-e[0]*t[2],e[0]*t[1]-e[1]*t[0]],T=e=>{const t=Math.hypot(e[0],e[1],e[2]);return t>0?[e[0]/t,e[1]/t,e[2]/t]:[0,0,1]},he=e=>{const t=T(e.normal),r=T(e.up),n=T(we(r,t)),u=T(we(t,n));return{right:n,up:u,normal:t}},Te=(e,t)=>[J(e,t.right),J(e,t.up),J(e,t.normal)],Be=(e,t)=>se(se(U(t.right,e[0]),U(t.up,e[1])),U(t.normal,e[2])),Ge=e=>[-e[0],e[1],-e[2]],me=(e,t,r)=>T(Be(Ge(Te(e,t)),r)),it=(e,t)=>{const r=he(t.source),n=he(t.target),u=st(e.position,t.source.position),o=Te(u,r),s=U(Ge(o),t.scale??1),c={position:se(t.target.position,Be(s,n))};return e.forward&&(c.forward=me(e.forward,r,n)),e.up&&(c.up=me(e.up,r,n)),c};new Ye;new b;new Ce;new Ce;const lt=(e=new Pe(2,3))=>{const t=new de(e.x,e.y),r=new Ke({visible:!1}),n=new q(t,r);return n.name="portal-plane",n.userData.portalSize=e.clone(),n},ct=`
varying vec2 vUv;
void main() {
  vUv = uv;
